package ru.mineplay.mineplayapi.api.holographic.impl;
...
import ru.mineplay.mineplayapi.api.holographic.line.*;
import ru.mineplay.mineplayapi.api.BukkitAPI;
import ru.mineplay.mineplayapi.api.holographic.ProtocolHolographic;
import ru.mineplay.mineplayapi.api.holographic.ProtocolHolographicLine;
...
public class SimpleHolographic implements ProtocolHolographic {
    ...
    @Override
    public void setAutoLooking(int radius) {
        holographicLines.forEach(line -> line.setAutoLooking(5));
    }
    @Override
    public void lazyLoad() {
        holographicLines.forEach(ProtocolHolographicLine::lazyLoad);
    }
    ...
    public void addViewers(@NonNull Player... players) {
        ...
        for (Player player : players) {
            BukkitAPI.HOLOGRAPHIC_MANAGER.addProtocolHolographic(player, this);
        }
    }
    ...
    public void removeViewers(@NonNull Player... players) {
        ...
        for (Player player : players) {
            BukkitAPI.HOLOGRAPHIC_MANAGER.removeProtocolHolographic(player, this);
        }
    }
