package ru.mineplay.mineplayapi.api.holographic.line;
...
import ru.mineplay.mineplayapi.api.protocollib.entity.impl.FakeArmorStand;
import ru.mineplay.mineplayapi.api.protocollib.entity.impl.FakeSilverfish;
...
public class ActionHolographicLine implements ProtocolHolographicLine {
    ...
    public void lazyLoad() {
        fakeArmorStand.lazyLoad();
        clickableSilverfish.lazyLoad();
    }
    @Override
    public void setAutoLooking(int radius) {
        fakeArmorStand.enableAutoLooking(radius);
        clickableSilverfish.enableAutoLooking(radius);
    }
