...
import ru.mineplay.mineplayapi.api.scoreboard.animation.ScoreboardDisplayStaticAnimation;
...
public final class BaseScoreboardBuilder {
    ...
    private BaseScoreboardScope scoreboardScope = BaseScoreboardScope.PRIVATE;

    private long durationTick;
    private ScoreboardUpdater scoreboardUpdater;

    private final TIntObjectMap<BaseScoreboardLine> scoreboardLineMap = new TIntObjectHashMap<>();
