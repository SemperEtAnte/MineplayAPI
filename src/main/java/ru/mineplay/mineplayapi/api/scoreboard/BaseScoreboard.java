...
import ru.mineplay.mineplayapi.api.protocollib.packet.scoreboard.WrapperPlayServerScoreboardDisplayObjective;
import ru.mineplay.mineplayapi.api.protocollib.packet.scoreboard.WrapperPlayServerScoreboardObjective;
import ru.mineplay.mineplayapi.api.utility.bukkit.MetadataUtil;
...
public class BaseScoreboard {
    ...
    public void addScoreboardUpdater(@NonNull ScoreboardUpdater scoreboardUpdater,
        ...
        }.runTaskTimer(MinePlayAPI.getPlugin(MinePlayAPI.class), durationTick, durationTick);
